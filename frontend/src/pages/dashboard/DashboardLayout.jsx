...
const DashboardLayout = () => {
  ...
  return (
    ...
    <div className="flex-grow text-gray-800">
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          ...
          <div className="border-l pl-3 ml-3 space-x-1">
            <button className="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
              ...
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-6 w-6">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.618V6a4 4 0 10-8 0v8.618a2.032 2.032 0 01-1.595 1.977L4 17h5m6 0v2a2 2 0 01-2 2H7a2 2 0 01-2-2v-2" />
              </svg>
            </button>
      ...
      <main className="py-8 sm:py-12 px-4 sm:px-10">
        <Outlet />
      </main>
    </div>
  </section>
